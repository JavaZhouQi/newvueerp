            ...
            <el-row :gutter="10">
                ...
                <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11">
                  ...
                  <el-row :gutter="10">
                      ...
                      <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11">
                        <div class="grid-content bg-purple-light">
                         <el-form-item label="重新入库" prop="toputinstorage">
                            <el-radio v-model="formLabelAlign.radio" label="1">是</el-radio>
                            <el-radio v-model="formLabelAlign.radio" label="2">否</el-radio>
                          </el-form-item>
                        </div>
                      </el-col>
