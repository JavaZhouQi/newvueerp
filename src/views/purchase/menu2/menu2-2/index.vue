...
<template>
  <div class>
    ...
    <el-dialog :title="titleDialog" width="60%" :visible.sync="addDialog" :before-close="handleClose">
      <el-dialog width="50%" title="历史交易查询" :visible.sync="innerVisible" :before-close="handleClose" append-to-body>
        <router-view :inner-visible.sync="innerVisible"></router-view>
      </el-dialog>
      <router-view :add-dialog.sync="addDialog" :inner-visible.sync="innerVisible"></router-view>
    </el-dialog>
  </div>
</template>
