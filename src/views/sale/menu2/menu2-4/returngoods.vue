...
<el-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1"><div class="grid-content bg-purple">单价是否含税</div></el-col>
   <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11"><div class="grid-content bg-purple-light">
       <el-form-item label="">
           <el-select v-model="formLabelAlign.due" placeholder="请选择" style="width:140px" >
                <el-option
...
<el-col :xs="8" :sm="6" :md="4" :lg="3" :xl="1"><div class="grid-content bg-purple">重新出库</div></el-col>
   <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11"><div class="grid-content bg-purple-light">
       <el-form-item label="">
           <el-select v-model="formLabelAlign.outhouseagain" placeholder="请选择" style="width:140px" >
                <el-option
                v-for="item in options"
                :key="item.value"
                :label="item.label"
   ...
   <el-col :xs="4" :sm="6" :md="8" :lg="9" :xl="11"><div class="grid-content bg-purple-light">
       <el-form-item label="">
           <el-select v-model="formLabelAlign.abroadtrade" placeholder="请选择" style="width:140px"  disabled >
                <el-option
                v-for="item in options"
                :key="item.value"
                :label="item.label"
