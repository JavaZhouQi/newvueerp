...
<template>
  <div class>
    ...
    <el-dialog title="其他出库单" :visible.sync="addDialog" width="50%" :before-close="handleClose">
      ...
      <el-form :model="sale_quotation" size="mini" :label-position="'left'"   ref="sale_quotation" label-width="100px" class="demo-ruleForm">
        <el-row>
            <el-col :span="12">
               <el-form-item label="出库类型"  prop="name"> <el-input v-model="sale_quotation.consumer.name"></el-input> </el-form-item>
            </el-col>
            <el-col :span="12">
            ...
            <el-tabs  type="card">
                <el-tab-pane label="内容" >
                    <el-table :data="sale_quotation.details" height="150" size="mini" max-height="250" border style="width: 97%">
                            ...
                            <el-table-column prop="zip" label="(批号)" width="100">
                            </el-table-column>
                ...
                <el-tab-pane label="备注" >
                    ...
                    <el-row>
                        <el-col :span="12">
                        <el-form-item label="出库人员"   prop="name"> 
                            <el-input v-model="sale_quotation.name"></el-input>
                        </el-form-item>
                        </el-col>
                        <el-col :span="12">
