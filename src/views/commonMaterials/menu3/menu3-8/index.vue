...
<template>
  <div class>
      ...
      <div style="margin-top: 15px;width:380px;float: left;">
        <el-input placeholder="请输入内容" v-model="selectValue" class="input-with-select">
          <el-select v-model="select" slot="prepend" placeholder="请选择">
            ...
            <el-option label="供应商编号" value="id"></el-option>
          </el-select>
    ...
    <el-table ref="filterTable" :data="tableData" style="width: 100%;margin-top:10px;">
      <el-table-column prop="id" label="供应商编号" sortable width="180" column-key="date"></el-table-column>
    ...
    <el-dialog title="编辑供应商" :visible.sync="addDialog" width="50%" :before-close="handleClose">
      <span>
...
export default {
  ...
  methods: {
    ...
    del(id) {
      request({
        url: "/comcustomer/del?id=" + id + "&flag=2",
        method: "get"
      }).then(result => {
        Message.success(result.data.data);
        this.findPage();
