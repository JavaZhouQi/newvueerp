...
<template>
  <div class>
      ...
      <div style="margin-top: 15px;width:380px;float: left;">
        <el-input placeholder="请输入内容" v-model="selectValue" class="input-with-select">
          <el-select v-model="select" slot="prepend" placeholder="请选择">
            ...
            <el-option label="仓库编号" value="wareHouseID"></el-option>
            <el-option label="仓库名称" value="wareHouseName"></el-option>
            <el-option label="仓库简称" value="shortName"></el-option>
            ...
            <el-option label="仓库地址" value="wareHouseAddress"></el-option>
    ...
    <el-table ref="filterTable" :data="tableData" style="width: 100%;margin-top:10px;">
      <el-table-column prop="wareHouseID" label="仓库编号" sortable width="100" column-key="date"></el-table-column>
      <el-table-column prop="wareHouseName" label="仓库名称" width="110"></el-table-column>
      <el-table-column prop="shortName" label="仓库简称" width="100"></el-table-column>
      <el-table-column prop="engName" label="英文名称" width="100"></el-table-column>
      ...
      <el-table-column prop="wareHouseAddress" label="仓库地址" width="160"></el-table-column>
      ...
      <el-table-column label="操作" width="180">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="danger" @click="del(scope.row.wareHouseID)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <page-helper @jumpPage="jumpPage" :page-number="currentPage" :totalCount="pagenumber"></page-helper>

    <el-dialog title="编辑仓库" :visible.sync="addDialog" width="30%" :before-close="handleClose">
      <span>
        <el-form :model="entity" label-position="left" label-width="80px" status-icon :rules="rules">
          <el-form-item label="仓库编号" prop="wareHouseID">
            <el-input v-model="entity.wareHouseID" :disabled="updatebool"></el-input>
          </el-form-item>
          <el-form-item label="仓库名称" prop="wareHouseName">
            <el-input v-model="entity.wareHouseName"></el-input>
          </el-form-item>
          ...
          <el-form-item label="仓库地址">
            <el-input v-model="entity.wareHouseAddress"></el-input>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    //保存后新增
    saveAddition(){
      var number = this.entity.wareHouseID
    },
    // 修改
    update(entity){
