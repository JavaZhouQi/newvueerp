...
<template>
  <div class>
      ...
      <div style="margin-top: 15px;width:380px;float: left;">
        <el-input placeholder="请输入内容" v-model="selectValue" class="input-with-select">
          <el-select v-model="select" slot="prepend" placeholder="请选择">
            ...
            <el-option label="地区编号" value="areaID"></el-option>
            <el-option label="地区名称" value="areaName"></el-option>
    ...
    <el-table ref="filterTable" :data="tableData" style="width: 100%;margin-top:10px;">
      <el-table-column prop="areaID" label="地区编号" sortable width="180" column-key="date"></el-table-column>
      <el-table-column prop="areaName" label="地区名称" width="180"></el-table-column>
      ...
      <el-table-column label="操作" width="280">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="danger" @click="del(scope.row.areaID)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <page-helper @jumpPage="jumpPage" :page-number="currentPage" :totalCount="pagenumber"></page-helper>

    <el-dialog title="编辑地区" :visible.sync="addDialog" width="30%" :before-close="handleClose">
      <span>
        <el-form :model="entity" label-position="left" label-width="80px" status-icon :rules="rules">
          <el-form-item label="地区编号" prop="areaID">
            <el-input v-model="entity.areaID" :disabled="updatebool"></el-input>
          </el-form-item>
          <el-form-item label="地区名称" prop="areaName">
            <el-input v-model="entity.areaName"></el-input>
          </el-form-item>
