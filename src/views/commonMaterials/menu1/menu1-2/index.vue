...
<template>
  <div class>
      ...
      <div style="margin-top: 15px;width:380px;float: left;">
        <el-input placeholder="请输入内容" v-model="selectValue" class="input-with-select">
          <el-select v-model="select" slot="prepend" placeholder="请选择">
            ...
            <el-option label="项目编号" value="projectID"></el-option>
    ...
    <el-table ref="filterTable" :data="tableData" style="width: 100%;margin-top:10px;">
      <el-table-column prop="projectID" label="项目编号" sortable width="180" column-key="date"></el-table-column>
      ...
      <el-table-column label="操作" width="280">
        <template slot-scope="scope">
          ...
          <el-button size="mini" type="danger" @click="del(scope.row.projectID)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    <page-helper @jumpPage="jumpPage" :page-number="currentPage" :totalCount="pagenumber"></page-helper>

    <el-dialog title="编辑项目" :visible.sync="addDialog" width="30%" :before-close="handleClose">
      <span>
        <el-form :model="entity" label-position="left" label-width="80px" status-icon :rules="rules">
          <el-form-item label="项目编号" prop="projectID">
            <el-input v-model="entity.projectID" :disabled="updatebool"></el-input>
          </el-form-item>
          <el-form-item label="项目名称" prop="projectName">
            <el-input v-model="entity.projectName"></el-input>
          </el-form-item>
