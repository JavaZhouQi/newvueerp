<template>
  <div class="app">
    ...
    <div
      ...
      v-show="show5"
      class="el-notification right"
      style="top: 16px; z-index: 2013; width:30%;  height:  300px ;"
    >
      <div class="el-notification__group">
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
            ...
            <div class="bb1">
              <div class="b1">
                <div class="tw">
                  ...
                  <p class="pp1">
                    <router-link to="/reportform/menu1/menu1-1">采购订单分析</router-link>
                  </p>
                </div>
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/cgdd6.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu1/menu1-2">订单分析明细</router-link>
                  </p>
                </div>
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/cgdd3.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu1/menu1-3">采购交易分析</router-link>
                  </p>
                </div>
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/cgdd4.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu1/menu1-4">交易分析明细</router-link>
                  </p>
                </div>
              </div>
              <div class="bb2">
                <div class="b1">
                  <div class="tw">
                    ...
                    <p class="pp1">
                      <router-link to="/reportform/menu1/menu1-6">开票状况分析</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/cgdd7.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu1/menu1-7">采购分摊明细</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/gysmx.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu1/menu1-5">&nbsp;供应商明细</router-link>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="bb1">
              <div class="b1">
                <div class="tw">
                  ...
                  <p class="pp1">
                    <router-link to="/reportform/menu2/menu2-1">销售订单分析</router-link>
                  </p>
                </div>
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/xsdd2.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu2/menu2-2">订单分析明细</router-link>
                  </p>
                </div>
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/ddfx1.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu2/menu2-3">销售交易分析</router-link>
                  </p>
                </div>
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/ddfx2.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu2/menu2-4">交易分析明细</router-link>
                  </p>
                </div>
              </div>
              <div class="bb2">
                <div class="b1">
                  <div class="tw">
                    ...
                    <p class="pp1">
                      <router-link to="/reportform/menu2/menu2-5">客户交易明细</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/kpzk.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu2/menu2-6">开票状况分析</router-link>
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="bb1">
              <div class="b1">
                <div class="tw">
                  ...
                  <p class="pp1">
                    <router-link to="/reportform/menu3/menu3-1">&nbsp;&nbsp;&nbsp;物料清单</router-link>
                  </p>
                </div>
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/kcgl.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu3/menu3-2">物料库存估量</router-link>
                  </p>
                </div>
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/kcgl1.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu3/menu3-3">库存估量明细</router-link>
                  </p>
                </div>
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/kccx.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu3/menu3-4">&nbsp;&nbsp;&nbsp;库存查询</router-link>
                  </p>
                </div>
              </div>
              <div class="bb2">
                <div class="b1">
                  <div class="tw">
                    ...
                    <p class="pp1">
                      <router-link to="/reportform/menu3/menu3-5">&nbsp;&nbsp;&nbsp;库存台账</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/kctz2.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu3/menu3-6">库存台账明细</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/jy1.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu3/menu3-7">批号库交易分析</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/jy2.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu3/menu3-8">批号库交易分析明细</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/dz.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu3/menu3-9">库存呆滞分析</router-link>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <el-tab-pane label="账款报表" name="fourth">
            <div class="bb1">
              <div class="b1">
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/yszk2.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu5/menu5-1">&nbsp;应收款报表</router-link>
                  </p>
                </div>
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/yfzk.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu5/menu5-2">应收款明细表</router-link>
                  </p>
                </div>
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/dzk.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu5/menu5-3">应收款账龄分析</router-link>
                  </p>
                </div>
                <div class="tw">
                  <img class="leftImg1" src="@/static/images/gyzl/zkcs.png" />
                  <p class="pp1">
                    <router-link to="/reportform/menu5/menu5-4">应收款账龄明细</router-link>
                  </p>
                </div>
              </div>
              <div class="bb2">
                <div class="b1">
                  <div class="tw">
                    ...
                    <p class="pp1">
                      <router-link to="/reportform/menu5/menu5-5">&nbsp;应付款报表</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/yfk2.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu5/menu5-6">应付款明细表</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/yfk3.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu5/menu5-7">应付款账龄分析</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/yfk4.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu5/menu5-8">应付款账龄明细</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/yfk6.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu5/menu5-9">应付佣金明细</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/yfk7.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu5/menu5-10">应收账款对账</router-link>
                    </p>
                  </div>
                  <div class="tw">
                    <img class="leftImg1" src="@/static/images/gyzl/yfk8.png" />
                    <p class="pp1">
                      <router-link to="/reportform/menu5/menu5-11">应付账款对账</router-link>
                    </p>
                  </div>
                </div>
              </div>
