<template>
  <div class="app">
    <el-container>
     ...
     <!-- 弹框 公用资料-->
        <div role="alert"  v-show="show" class="el-notification right" style="top: 16px; z-index: 2013; width:20%;  height:  300px ;">
  ...
  <!-- 弹框 采购管理-->
     <div role="alert"  v-show="show2" class="el-notification right" style="top: 16px; z-index: 2013; width:20%;  height:  300px ;">
      <div class="el-notification__group">
  ...
  <!-- 弹框 销售-->
     <div role="alert"  v-show="show3" class="el-notification right" style="top: 16px; z-index: 2013; width:20%;  height:  300px ;">
      <div class="el-notification__group">
 ...
 <!-- 弹框 库存-->
     <div role="alert"  v-show="show4" class="el-notification right" style="top: 16px; z-index: 2013; width:16%;  height:  300px ;">
      <div class="el-notification__group">
