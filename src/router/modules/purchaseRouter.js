...
const purchaseRouter = {
    ...
    children: [
      {
        path: '/purchase/menu1',
        component: () => import('@/views/purchase/menu1/index'),
        name: 'purchaseMenu1',
      ...
      {
        path: '/purchase/menu2',
        component: () => import('@/views/purchase/menu2/index'),
        name: 'purchaseMenu2',
        ...
        children: [
          {
            ...
            component: () => import('@/views/purchase/menu2/menu2-1'),
            ...
            children:[
              {
                path:'/operateQg',
                name:'operateQg',
                component:() => import('@/views/purchase/menu2/menu2-1/operate')
              }
            ]
          },
          {
            path: '/purchase/menu2/menu2-2',
            component: () => import('@/views/purchase/menu2/menu2-2'),
            ...
            children:[
              {
                path:'/operateXj',
                name:'operateXj',
                component:() => import('@/views/purchase/menu2/menu2-2/operate')
              },
              {
                path:'/historical',
                name:'historical',
                component:() => import('@/views/purchase/menu2/menu2-2/historical')
          ...
          },
          {
            ...
            component: () => import('@/views/purchase/menu2/menu2-3'),
            ...
            children:[
              {
                path:'/operateDd',
                name:'operateDd',
                component:() => import('@/views/purchase/menu2/menu2-3/operate')
              },
              {
                path:'/historical',
                name:'historical',
      ...
      {
        path: '/purchase/menu3',
        component: () => import('@/views/purchase/menu3/index'),
        name: 'purchaseMenu3',
        ...
        children: [
          {
            ...
            component: () => import('@/views/purchase/menu3/menu3-1'),
